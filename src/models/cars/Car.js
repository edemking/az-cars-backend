...
const carSchema = new mongoose.Schema({
  ...
  componentSummary: {
    windowsSunroof: componentItemSchema,
    windowControl: componentItemSchema,
    ...
    frontSeats: componentItemSchema,
    backSeats: componentItemSchema,
    sunroof: componentItemSchema,
    fourWDSystem: componentItemSchema,
    glovebox: componentItemSchema,
    paint: componentItemSchema,
    dashboard: componentItemSchema,
    lights: componentItemSchema,
    dashLight: componentItemSchema,
