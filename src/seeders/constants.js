...
// Vehicle Type IDs
const VEHICLE_TYPES = {
  SEDAN: createId('6470a9ae10b5d12345679101'),
  SUV: createId('6470a9ae10b5d12345679102'),
  HATCHBACK: createId('6470a9ae10b5d12345679103'),
  COUPE: createId('6470a9ae10b5d12345679104'),
  CONVERTIBLE: createId('6470a9ae10b5d12345679105'),
  WAGON: createId('6470a9ae10b5d12345679106'),
  CROSSOVER: createId('6470a9ae10b5d12345679107'),
  MINIVAN: createId('6470a9ae10b5d12345679108'),
  PICKUP: createId('6470a9ae10b5d12345679109'),
  SPORTS_CAR: createId('6470a9ae10b5d12345679110')
};
